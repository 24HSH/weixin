...
public class UnifiedOrderServiceImpl implements IUnifiedOrderService {
	...
	private static Logger logger = Logger.getLogger(UnifiedOrderServiceImpl.class);

	@Override
	public String unifiedOrder(UnifiedOrder unifiedOrder, String key) throws RuntimeException {
